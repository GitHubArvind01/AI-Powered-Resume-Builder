...
public class ResumeResource {
    ...
    public ResponseEntity<ResumeResponseDTO> createResume(@Valid @RequestBody ResumeRequestDTO resumeRequestDTO) {
        ResumeResponseDTO createdResume = resumeService.createResume(resumeRequestDTO);
    ...
    public ResponseEntity<ResumeResponseDTO> updateResume(
        ...
        ResumeResponseDTO updatedResume = resumeService.updateResume(id, resumeRequestDTO);
