package com.resumeai.template_service.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.resumeai.template_service.controller..*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(* com.resumeai.template_service.service..*(..))")
