package com.resumeai.resume_service.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.resumeai.resume_service.controller..*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(* com.resumeai.resume_service.service..*(..))")
