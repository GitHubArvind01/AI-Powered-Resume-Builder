...
class ResumeServiceImplTest {
    ...
    @Test
    @DisplayName("Should successfully delete a resume")
    ...
    @Test
    @DisplayName("Should throw exception when deleting non-existent resume")
    void testDeleteResumeNotFound() {
        ...
        verify(resumeRepository, times(1)).existsById(999L);
    }
