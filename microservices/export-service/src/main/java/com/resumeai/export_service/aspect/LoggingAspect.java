package com.resumeai.export_service.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.resumeai.export_service.controller..*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(* com.resumeai.export_service.service..*(..))")
