package com.resumeai.payment_service.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.resumeai.payment_service.controller..*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(* com.resumeai.payment_service.service..*(..))")
