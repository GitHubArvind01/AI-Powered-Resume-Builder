package com.resumeai.notification_service.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.resumeai.notification_service.controller..*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(* com.resumeai.notification_service.service..*(..))")
